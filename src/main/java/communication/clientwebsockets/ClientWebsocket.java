...
import communication.messages.MessageConnectAsFilter;
...
public class ClientWebsocket extends WebsocketBase implements IClientWebsocket {
    ...
    private static final String serverUri = "ws://localhost:8090/analyserserver/websocket/";
    ...
    public void onWebSocketConnect(Session session){
        ...
        Logger.getInstance().log("Connected", LogLevel.INFORMATION);
        MessageConnectAsFilter msg = new MessageConnectAsFilter("Pleb01");
        send(msg);
    }
